...
- [x] Аудит лог **UI** (админ самбарт хэн юу хийснийг харах хуудас) — §7 модуль #15-ыг эндээс дуусгана
      ...
      "Аудит лог" мөрийн "BRANCH_ADMIN R (өөрийн)" анхны төлөвлөгөө БҮРЭН
      хэрэгжээгүй** — `AuditInterceptor.writeAuditLog()`
      (src/common/audit.interceptor.ts) `branchId` баганыг ХЭЗЭЭ Ч
      populate хийдэггүй (үргэлж `null`) тул зөвхөн 3 глобал-эрхийн дүрд
